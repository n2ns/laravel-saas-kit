...
use App\Jobs\StripeWebhooks\HandleStripeWebhookJob;
...
return [
     ...
     */
    'default_job' => HandleStripeWebhookJob::class,
    ...
    'connection' => env('STRIPE_WEBHOOK_CONNECTION', env('QUEUE_CONNECTION', 'database')),
