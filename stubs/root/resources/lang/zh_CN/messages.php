...
return [
    ...
    // Meta
    'meta' => [
        'description' => 'SaaS Starter 是一个 Laravel 产品站模板，内置登录认证、订阅支付、产品页面、博客发布、SEO 和管理后台。',
        'keywords' => 'SaaS, Laravel, 产品站, 订阅支付, 博客发布, 产品目录, SEO, 管理后台',
    ...
    'cookie' => [
        'title' => '我们使用 Cookie',
        'description' => '我们使用 Cookie 来提升您的浏览体验、分析网站流量和个性化内容。点击"接受"即表示您同意我们使用 Cookie。',
        'accept' => '接受',
        'decline' => '拒绝',
        'privacy_link' => '了解更多',
    ],
