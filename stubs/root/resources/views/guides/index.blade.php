...
<div class="bg-bg-body min-h-screen">
    ...
    <!-- Page header -->
    <div class="border-b border-black/[0.08] relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-12 relative z-10">
            ...
            <div class="flex items-center gap-2 text-xs text-slate-500 mb-4">
                ...
                <span class="text-slate-600">Guides</span>
            </div>
            <p class="section-label mb-3">Guides</p>
            <h1 class="text-3xl md:text-5xl font-bold text-slate-950 tracking-tighter leading-tight mb-4">
                {{ $title }}
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
            @forelse($guides as $guide)
                <article class="ui-card ui-card-lift rounded-2xl overflow-hidden group flex flex-col h-full">
                    ...
                    @else
                        <div class="aspect-video bg-white flex items-center justify-center flex-shrink-0 border-b border-black/[0.08]">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <!-- Title -->
                        <h2 class="text-base font-bold text-slate-950 mb-3 group-hover:text-primary-400 transition-colors line-clamp-2 leading-snug tracking-tight">
                        ...
                        <!-- Excerpt -->
                        <p class="text-slate-600 text-sm mb-5 line-clamp-2 leading-relaxed flex-grow">
                            {{ $guide->getTranslation('excerpt', app()->getLocale()) }}
                        </p>

                        <!-- Footer -->
                        <div class="flex items-center justify-between pt-4 border-t border-black/[0.08] mt-auto">
                            <a href="{{ localized_route('catalog.guides.show', ['productCode' => $productCode, 'slug' => $guide->slug]) }}"
            ...
            @empty
                <div class="col-span-full py-24 text-center">
                    ...
                    <p class="text-slate-600 text-sm">No guides published yet.</p>
                </div>
            @endforelse
        </div>
