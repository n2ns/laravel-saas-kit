...
<div class="about-page bg-bg-body">
    <section class="pt-10 pb-16 md:pt-16 md:pb-24 border-b border-white/[0.06] relative overflow-hidden">
    ...
    <section class="pt-10 pb-16 md:pt-16 md:pb-24 border-b border-white/[0.06]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="ui-card ui-card-lift p-6 rounded-2xl">
                    <div class="w-12 h-12 rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center mb-4">
                        <i data-lucide="layout-template" class="w-6 h-6 text-primary-400"></i>
                    </div>
                    <h2 class="text-sm font-bold text-white mb-2 tracking-tight">{{ __('about.section_overview_title') }}</h2>
                    <p class="text-slate-400 text-sm leading-relaxed">{{ __('about.section_overview_body') }}</p>
                </div>
                ...
                <div class="ui-card ui-card-lift p-6 rounded-2xl">
                    ...
                    <h2 class="text-sm font-bold text-white mb-2 tracking-tight">{{ __('about.section_mission_title') }}</h2>
                    <p class="text-slate-400 text-sm leading-relaxed">{{ __('about.section_mission_body') }}</p>
                </div>

                <div class="ui-card ui-card-lift p-6 rounded-2xl">
                    <div class="w-12 h-12 rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center mb-4">
                        <i data-lucide="mail" class="w-6 h-6 text-emerald-400"></i>
                    </div>
                    <h2 class="text-sm font-bold text-white mb-2 tracking-tight">{{ __('about.section_contact_title') }}</h2>
                    <p class="text-slate-400 text-sm leading-relaxed">{{ __('about.section_contact_body') }}</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-2xl">
                ...
                <a href="{{ localized_route('support') }}"
                   class="btn-primary px-8 py-3.5 text-base rounded-xl shadow-xl shadow-white/10">
                    {{ __('about.cta_button') }}
                </a>
            </div>
        </div>
