    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-base prose-invert max-w-4xl">
            <div class="space-y-10 text-left">
                ...
                <div class="rounded-2xl border border-white/5 bg-slate-900/70 p-6 not-prose">
                    <h2 class="text-lg md:text-2xl font-bold text-white mb-4 tracking-tight">
                        Privacy and Terms
                    </h2>
                    <p class="text-slate-400 leading-relaxed text-base md:text-lg mb-5">
                ...
                <div class="mt-12 p-6 bg-slate-900 border border-white/5 rounded-2xl not-prose">
